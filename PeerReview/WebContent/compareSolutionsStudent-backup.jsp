...
<body>
	...
	<div style="width: 100%;">
		...
		<form name="compareSolutionsStudent" action="CompareSolutionsStudent"
			...
			<div style="width: 100%;">
				<div
					style="float: left; width: 50% margin: auto; border: 2px solid #73AD21; padding: 10px;">
					...
					<input id="leftSolutionNumber" name="leftSolutionNumber"
						placeholder="P1" tabindex="1" type="text" readonly="readonly"
					...
					<input id="leftProblemSolutionPair" name="leftProblemSolutionPair"
						placeholder="P1" tabindex="1" type="hidden"
						value="<%=sampleSolution1.getProblem_Solution_Pair()%>">

					<p class="contact">
						<label for="leftSampleCode">Sample solution code</label>
					</p>
					<textarea id="leftSampleCode" name="leftSampleCode" cols="60"
						rows="30" readonly="readonly"><%=firstSampleCode%></textarea>
				...
				<div
					style="float: right; width: 50% width: 50% margin: auto; border: 2px solid #73AD21; padding: 10px;">
					...
					<p class="contact">
						<label for="rightProblemSolutionPair">Problem Solution
							Pair</label>
					</p>
					<input id="rightProblemSolutionPair"
						name="rightProblemSolutionPair" placeholder="P1" tabindex="1"
					...
					<textarea id="rightSampleCode" name="rightSampleCode" cols="60"
						rows="30" readonly="readonly"><%=secondSampleCode%></textarea>
			...
			<div style="width: 100%;">
				<div
					style="float: left; width: 50% margin: auto; border: 2px solid #73AD21; padding: 10px; height: 150px;">
					<p>
						<label>Choose better solution: </label> <br> <select
							...
							<option><%=sampleSolution1.getSolution_Number()%> is the
								better solution
							</option>
							<option><%=sampleSolution2.getSolution_Number()%> is the
								better solution
							</option>
							<option>Both
				...
				<div id="hidden-div"
					style="float: right; width: 50% margin: auto; border: 2px solid #73AD21; padding: 10px; height: 150px; display: none">
					<p class="contact">
