...
<body>
	<div id="wrap">
		<ul class="navbar">
			...
			<li><a href="viewStudentRankingList">Finished Reviews</a></li>
            ...
            //int id = Integer.parseInt(request.getParameter("updateId"));
				...
				<form method="post" action="UserSecondSolutionListSelection" name="firstform">
            	<div id="mystyle" class="myform">
                    ...
                    <input type="text" name="problemName" id="problemName" readonly="readonly" value="<%=problem.getProblemName()%>"/>
                   	<input type="hidden" id="userName" name="userName" 
									value="<%=userName%>"/>
                    <label>Select first solution for comparison <span class="small">First Solution</span></label>
